<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ViewAssignmentGrade.aspx.cs" Inherits="Milestone3.ViewAssignmentGrade" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <br />
            <br />
            Student ID<asp:TextBox ID="sid" runat="server" CssClass="auto-style12"></asp:TextBox>
            <br />
